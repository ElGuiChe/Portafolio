...
export default function ExperienceContainer() {
    ...
    return (
        <section className="mb-4" id="experiencia">
            ...
            <small>
                <a ClassName="aprueba" Style={"color: rgb(94, 234, 212) !important"} href='https://raw.githubusercontent.com/ElGuiChe/Portafolio/master/public/CV%20Guillermo%20Galarraga%20Español.pdf' target="_blank" rel="noopener noreferrer">Echa un vistazo a mi CV completo aquí</a>
            </small>
        </section>
    )
}